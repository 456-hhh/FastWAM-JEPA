...
def test_jepa_future_predictor_loads_matching_vjepa2ac_trunk_keys():
    ...
    fake_vjepa2ac_state = {
        "module.predictor_embed.weight": torch.randn_like(predictor.predictor_embed.weight),
        "module.predictor_embed.bias": torch.randn_like(predictor.predictor_embed.bias),
        "module.predictor_blocks.0.norm1.weight": torch.randn_like(block.norm_self.weight),
        "module.predictor_blocks.0.norm1.bias": torch.randn_like(block.norm_self.bias),
        "module.predictor_blocks.0.attn.qkv.weight": torch.randn_like(block.self_attn.qkv.weight),
        "module.predictor_blocks.0.attn.qkv.bias": torch.randn_like(block.self_attn.qkv.bias),
        "module.predictor_blocks.0.attn.proj.weight": torch.randn_like(block.self_attn.out.weight),
        "module.predictor_blocks.0.attn.proj.bias": torch.randn_like(block.self_attn.out.bias),
        "module.predictor_blocks.0.norm2.weight": torch.randn_like(block.norm_mlp.weight),
        "module.predictor_blocks.0.norm2.bias": torch.randn_like(block.norm_mlp.bias),
        "module.predictor_blocks.0.mlp.fc1.weight": torch.randn_like(block.mlp[0].weight),
        "module.predictor_blocks.0.mlp.fc1.bias": torch.randn_like(block.mlp[0].bias),
        "module.predictor_blocks.0.mlp.fc2.weight": torch.randn_like(block.mlp[3].weight),
        "module.predictor_blocks.0.mlp.fc2.bias": torch.randn_like(block.mlp[3].bias),
        "module.norm.weight": torch.randn_like(predictor.predictor_norm.weight),
        "module.norm.bias": torch.randn_like(predictor.predictor_norm.bias),
        "module.proj.weight": torch.randn_like(predictor.predictor_proj.weight),
        "module.proj.bias": torch.randn_like(predictor.predictor_proj.bias),
        "module.action_encoder.weight": torch.randn(64, 7),
    }
